...
socket.on('return', function(msg) {
    // NOTE: some browsers / transports may reorder object keys; do not rely on Object.keys(msg)[0]
    console.log("RETURN")
    console.log(msg)
    ...
    if (msg && Object.prototype.hasOwnProperty.call(msg, 'tempchange')) {
        ...
        const type = (rawType === 'error') ? 'danger' : rawType; // bootstrap uses 'danger' not 'error'
        appendAlert(msg.tempchange, type);
    }

    // statechange overlays
