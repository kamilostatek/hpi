...
(function () {
  ...
  function applyAoodZoneUI(zone, antiOnOffOn) {
    ...
    const titleEl = document.getElementById('aood-title');    const zoneWrap = document.getElementById('aood-zone-wrap');
    ...
    // Right side: Δt vs icon    if (zoneWrap) zoneWrap.classList.toggle('d-none', !(isZone && antiOnOffOn));
...
// ==== WYBÓR TRYBU – temperatury i tytuł (jak w 1.39) ====
  ...
  // (Δt rendering handled centrally in static/socket.js)
