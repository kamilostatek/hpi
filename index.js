...
function pickFlimitModeFromData(data) {
  ...
  function refresh(dataMaybe) {
    ...
    if (presetAutoChangeFromData) lastPresetAutoChange = presetAutoChangeFromData;
        ...
        if (dataMaybe && dataMaybe.antionoff !== undefined) { lastAntiOnOffOn = (String(dataMaybe.antionoff) === "1"); }
    const antiOnOffOn = (lastAntiOnOffOn !== null) ? lastAntiOnOffOn : false;
